...
var $author$project$Main$initModel = {age: $elm$core$Maybe$Nothing, firstname: $elm$core$Maybe$Nothing, message: 'welcomoe'};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$Attributes$placeholder('please input your name'),
				$elm$html$Html$Attributes$value(
				$author$project$Main$maybeDefaultEmptyString(firstname))
			]),
		_List_Nil);
};
var $author$project$Main$viewLength = function (aString) {
	return $elm$html$Html$text(
		$elm$core$String$fromInt(
			$elm$core$String$length(
				$author$project$Main$maybeDefaultEmptyString(aString))));
};
