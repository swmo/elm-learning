...
var $author$project$Main$darkModeColors = {
	primary: A3($mdgriffith$elm_ui$Element$rgb255, 255, 138, 128),
	primaryDark: A3($mdgriffith$elm_ui$Element$rgb255, 200, 90, 84),
	primaryLight: A3($mdgriffith$elm_ui$Element$rgb255, 255, 188, 175),
	secondary: A3($mdgriffith$elm_ui$Element$rgb255, 130, 177, 255),
	secondaryDark: A3($mdgriffith$elm_ui$Element$rgb255, 77, 130, 203),
	secondaryLight: A3($mdgriffith$elm_ui$Element$rgb255, 182, 227, 255),
...
var $author$project$Main$lightModeColors = {
	primary: A3($mdgriffith$elm_ui$Element$rgb255, 130, 177, 255),
	primaryDark: A3($mdgriffith$elm_ui$Element$rgb255, 77, 130, 203),
	primaryLight: A3($mdgriffith$elm_ui$Element$rgb255, 182, 227, 255),
	secondary: A3($mdgriffith$elm_ui$Element$rgb255, 255, 138, 128),
	secondaryDark: A3($mdgriffith$elm_ui$Element$rgb255, 200, 90, 84),
	secondaryLight: A3($mdgriffith$elm_ui$Element$rgb255, 255, 188, 175),
	textOnPrimary: A3($mdgriffith$elm_ui$Element$rgb255, 0, 0, 0),
	textOnSecondary: A3($mdgriffith$elm_ui$Element$rgb255, 0, 0, 0)
};
var $author$project$Main$update = F2(
	function (_v0, model) {
		return _Utils_eq(model.primary, $author$project$Main$darkModeColors.primary) ? $author$project$Main$lightModeColors : $author$project$Main$darkModeColors;
	});
var $author$project$Main$MsgChangeColorMode = {$: 'MsgChangeColorMode'};
...
var $author$project$Main$buttonChangeColorMode = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$Input$button,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$color(model.secondaryLight),
			...
			]),
		{
			...
			onPress: $elm$core$Maybe$Just($author$project$Main$MsgChangeColorMode)
		});
};
...
var $author$project$Main$dogImage = A2(
	...
	{description: 'picture of a dog', src: 'dog.png'});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Font$color(model.textOnPrimary)
			]),
		_List_fromArray(
			[
				A2(
...
var $author$project$Main$fontTippa = $mdgriffith$elm_ui$Element$Font$family(
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$Font$typeface('Tippa')
		]));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Font$bold,
				$mdgriffith$elm_ui$Element$Font$color(model.primaryDark),
				$author$project$Main$fontTippa,
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Main$buttonChangeColorMode(model),
...
var $author$project$Main$main = $elm$browser$Browser$sandbox(
	{init: $author$project$Main$darkModeColors, update: $author$project$Main$update, view: $author$project$Main$viewLayout});
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"MsgChangeColorMode":[]}}}}})}});}(this));